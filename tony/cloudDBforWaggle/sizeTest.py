...
class DataAgent():
    ...
    def __init__(self, filePath, db_connector):
        ...
        self.RMQHOST = getLanIP() #'127.0.0.1' #getLanIP() #'192.168.1.26' # '149.165.149.8'
    ...
    def consume_func(self, ch, method, properties, body):
        ...
        #print "GOT: '%s'" % body
        print "msg received: " + str(self.msgNum)
...
if __name__ == '__main__':
    ...
    #hosts = ['149.165.149.3', '149.165.149.25']
    #keyspace = 'weatherdb'
    #myConn = CassConnector(hosts, keyspace)
    agent = DataAgent(filePath, None)
    agent.consumeLoop()
